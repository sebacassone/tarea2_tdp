...
Luego, se hace un análisis post-hoc.
...
Con los p-value obtenidos entre todos los grupos, podemos concluir que existen diferencias significativas entre todos los tiempos.